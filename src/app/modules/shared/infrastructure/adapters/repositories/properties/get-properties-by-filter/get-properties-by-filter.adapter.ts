import type { GetPropertiesByFilterCommand } from '@/modules/shared/domain/commands/property.command';
...
export const getPropertiesByFilterAdapter = async (args: GetPropertiesByFilterCommand): Promise<Array<Property>> => {
