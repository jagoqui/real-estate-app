import type { LoginWithEmailAndPasswordInput } from '@/modules/shared/domain/inputs/auth.input';
...
export const loginWithEmailAndPasswordAction = async (input: LoginWithEmailAndPasswordInput): Promise<Auth> => {
