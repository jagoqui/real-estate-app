...
export const getPropertiesByOwnerIdAdapter = async (args: GetPropertiesByOwnerIdCommand): Promise<Array<Property>> => {
  const url = PROPERTY_ENDPOINTS.BY_OWNER_ID(args.ownerId);
