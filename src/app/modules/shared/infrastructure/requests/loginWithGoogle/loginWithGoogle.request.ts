...
import type {LoginWithGoogleRequest} from '@/modules/shared/domain/contracts/authRequest.contract';
...
export const loginWithGoogleRequest: LoginWithGoogleRequest = async ({
  code,
}): Promise<AuthResponse> => {
  const authResponseDto = await api
    .post<AuthResponseDto>(LOGIN_WITH_GOOGLE_REQUEST_URL, {json: {code}})
    .json();
