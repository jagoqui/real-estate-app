...
import { type PropertyTypes } from '@/modules/shared/domain/models/propertyTypes.model';
import { propertyTypesSchema } from '@/modules/shared/infrastructure/schemas/propertyTypes.schema';
