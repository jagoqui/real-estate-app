...
import type { CreateUserCommand2 } from '@/modules/shared/application/commands/create-user.command';
...
const DEFAULT_CREATE_USER: CreateUserCommand2 = {
  name: '',
  email: '',
...
export const UserManagementDialog = ({
  ...
  const [createForm, setCreateForm] = useState<CreateUserCommand2>(DEFAULT_CREATE_USER);
