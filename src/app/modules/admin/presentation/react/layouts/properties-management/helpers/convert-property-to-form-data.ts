import type { UpdatePropertyCommand2 } from '@/modules/shared/application/commands/property.command';
...
export const convertPropertyToFormData = async (property: Property): Promise<UpdatePropertyCommand2> => {
  ...
  const formData: UpdatePropertyCommand2 = {
    ...property,
