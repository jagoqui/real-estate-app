...
import { useDeleteUserRequest } from '@/modules/shared/infrastructure/ui/react/hooks/useDeleteUserRequest/useDeleteUserRequest';
...
import { UserManagementDialog } from '../../components/userManagementDialog/userManagementDialog';
...
export const UsersManagementLayout = (): React.ReactElement => {
  ...
  const { onRefetchGetUsers, isPending: isPendingUsers, error: usersError, data: users } = useGetUsersRequest();
  ...
  const {
    ...
    onSuccess: () => void onRefetchGetUsers(),
  });
                ...
                <TableRow key={user.id}>
                  ...
                  <TableCell className="text-right">
                    <div className="flex justify-end gap-2">
                      ...
                      <Button variant="ghost" size="icon" onClick={() => handleDelete(user.id)} disabled={user.isAdmin}>
