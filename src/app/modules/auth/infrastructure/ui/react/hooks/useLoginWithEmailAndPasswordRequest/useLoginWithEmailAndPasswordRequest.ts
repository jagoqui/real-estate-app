...
type LoginWithEmailAndPasswordRequestArgs =
  Parameters<LoginWithEmailAndPasswordRequestReturn>[number];

type LoginWithEmailAndPasswordRequestReturnValue = Awaited<
  ReturnType<LoginWithEmailAndPasswordRequestReturn>
>;
...
export const useLoginWithEmailAndPasswordRequest =
  (): UseLoginWithEmailAndPasswordRequestReturn => {
